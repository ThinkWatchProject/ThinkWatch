...
('aws-docs',   'AWS Documentation', 'Search and browse AWS service documentation',                    'knowledge',      '{"docs","aws","cloud"}',      'https://docs.aws.amazon.com/mcp', 'none', NULL,                                                                                      'hosted', false),
...
('notion',     'Notion',       'Read and write Notion pages, databases, and blocks',                  'productivity',   '{"notes","wiki","docs"}',     'https://mcp.notion.so',       'bearer', 'Go to Notion → Settings → My connections → Create new integration',                            'hosted', false),
